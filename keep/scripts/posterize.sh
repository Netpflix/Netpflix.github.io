...
## an array of images
declare -a arr=("skypfall.png" "pfellowship-of-the-ring.png" "pfinding-nemo.png" "pforrest-gump.png" "the-pforz-awakens.png" "back-to-the-pfuture.png" "pfrozen.png" "downpfall.png" "downpfall.jpg")
